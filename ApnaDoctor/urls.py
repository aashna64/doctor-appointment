...
from main.views import HomeView, Diabetes, Heart, Breast, consultation, appointment, registration, login, signup, signout, admin_view, add_doctor, consultation_request, consultation_delete, doctor_list,history,delete_history,service
